...
MathInterface.prototype.callOperation = function(digitRange, operation, mode){
	...
	resultsGenerator.attempts = resultsGenerator.attempts + 1;
...
MathInterface.prototype.compareResults = function(userValue){
	...
	this.setUI(resultsGenerator.attempts, "attempts");
}
...
MathInterface.prototype.reset =function(){
	this.setUI(" ", "correctness");
	this.setUI("", "marks");
	this.setUI("", "level");
	this.setUI("", "mathematicalStatement");
	this.setUI("", "attempts");
	resultsGenerator.systemResult = 0;
	resultsGenerator.marks = 0;
	resultsGenerator.triggured = true;
	resultsGenerator.level = 0;
	resultsGenerator.attempts = 0;
}
